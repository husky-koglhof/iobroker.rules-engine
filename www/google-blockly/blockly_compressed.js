    ...
    if (goog.inHtmlDocument_()) {
        ...
        if (void 0 === b)if (goog.IS_OLD_IE_) {
            ...
            c.write('<script type="text/javascript" src="' +
                a + '"' + d + ">\x3c/script>")
        } else goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(a) : goog.writeScriptSrcNode_(a); else c.write('<script type="text/javascript">' + b + "\x3c/script>");
        return !0
    }
    return !1
...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            var l = n.exec(h) || ["", "", ""], m = p.exec(k) || ["", "", ""];
            if (0 == l[0].length && 0 == m[0].length)break;
            var c = 0 == l[1].length ? 0 : parseInt(l[1], 10), q = 0 == m[1].length ? 0 : parseInt(m[1], 10), c = goog.string.compareElements_(c, q) || goog.string.compareElements_(0 ==
...
goog.dom.createTable_ = function (a, b, c, d) {
    for (var e = a.createElement(goog.dom.TagName.TABLE), f = e.appendChild(a.createElement(goog.dom.TagName.TBODY)), g = 0; g < b; g++) {
        for (var h = a.createElement(goog.dom.TagName.TR), k = 0; k < c; k++) {
            var n = a.createElement(goog.dom.TagName.TD);
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e)a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), n = Math.cos(h), p = this.getBubbleSize(), h = (p.width + p.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, p.width, p.height) / 2, p = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b +
            p * d, e = c + p * e, p = b + h * n, l = c + h * k, b = b - h * n, c = c - h * k, k = g + this.arrow_radians_;
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
    ...
    if (Blockly.isRightButton(a))a.stopPropagation(); else {
        var b = Blockly.mouseToSvg(a, this.workspace_.getParentSvg()), b = this.horizontal_ ? b.x : b.y, c = Blockly.getSvgXY_(this.svgHandle_, this.workspace_), c = this.horizontal_ ? c.x : c.y, d = this.handlePosition_, e = .95 * this.handleLength_;
...
Blockly.Procedures.flyoutCategory = function (a) {
    function b(a, b) {
        for (var d = 0; d < a.length; d++) {
            var h = a[d][0], k = a[d][1], n = goog.dom.createDom("block");
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    for (var b = [], c = [], d = this.permanentlyDisabled_.length = 0, e; e = a[d]; d++)if (e.tagName && "BLOCK" == e.tagName.toUpperCase()) {
...
Blockly.Flyout.prototype.reflowVertical = function (a) {
    ...
    if (this.width_ != b) {
        for (c = 0; d = a[c]; c++) {
            e = d.getHeightWidth();
            if (this.RTL) {
                var f = d.getRelativeToSurfaceXY().x, g = b - this.MARGIN, g = g / this.workspace_.scale, g = g - Blockly.BlockSvg.TAB_WIDTH;
                d.moveBy(g - f, 0)
            }
...
Blockly.Toolbox.prototype.populate_ = function (a) {
    function b(a, g, h) {
        for (var k = null, n = 0, p; p = a.childNodes[n]; n++)if (p.tagName)switch (p.tagName.toUpperCase()) {
            case "CATEGORY":
    ...
    b.readOnly || b.hasScrollbars || c.addChangeListener(function () {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop <
                ...
                var n = k.getRelativeToSurfaceXY(), p = k.getHeightWidth(), l = f + 25 - p.height - n.y;
                0 < l && k.moveBy(0, l);
                l = f + a.viewHeight - 25 - n.y;
                0 > l && k.moveBy(0, l);
                l = 25 + e - n.x - (b.RTL ? 0 : p.width);
                0 < l && k.moveBy(l, 0);
                n = e + a.viewWidth - 25 - n.x + (b.RTL ? p.width : 0);
                0 > n && k.moveBy(n, 0)
            }
        }
    });
...
Blockly.getMainWorkspaceMetrics_ = function () {
    ...
    var b = Blockly.Flyout.prototype.CORNER_RADIUS - 1, c = a.width - b, d = a.height - b, e = this.getBlocksBoundingBox(), f = e.width * this.scale, g = e.height *
        this.scale, h = e.x * this.scale, k = e.y * this.scale;
